...
//		RpcClient.connect("localhost", 8081);
//
//		RpcClient.getInstance().getChannel().writeAndFlush(new RpcRequest("aaaaaaaaaaaa", VFile.VFILE, VFile.VFILE, true, false, 10000, new Object[] { new byte[]{1,2,3} })).addListener(ChannelFutureListener.FIRE_EXCEPTION_ON_FAILURE);
//		
//	}
//
//}
